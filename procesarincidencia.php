...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_FILES['archivo']) && $_FILES['archivo']['error'] == UPLOAD_ERR_OK) {
        ...
        $ruta_archivo = ''; // O manejar el error de la forma que prefieras
    }

    try {
        // Preparar la consulta SQL para insertar datos en la tabla insidencias
        $sql = "INSERT INTO insidencias (titulo, descripcion, Archivo, fecha, id_estado, id_usuario) 
        ...
        $id_estado = 1; // Por ejemplo, asumiendo que el estado inicial es 1 (Abierta)
